...
classifier_bin = path.join(result_dir, 'classifier.bin')
input_file = path.join(test_dir, 'dbpedia.train')
pred_file  = path.join(data_dir, 'classifier_pred_test.txt')
output = path.join(result_dir, 'generated_classifier')
test_result = path.join(result_dir, 'classifier_test_result.txt')
pred_result = path.join(result_dir, 'classifier_pred_result.txt')
